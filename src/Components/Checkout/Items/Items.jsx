        ...
        <div key={index} className={styles.item}>
          ...
          <div className={styles.itemDetails}>
            <div className={styles.quantitypricecontrol}>
              <div className={styles.itemPrice}>SAR {item.price}</div>
              <div className={styles.quantityControls}>
                <button
                  className={styles.cartbutton1}
                  onClick={() => handleDecreaseQuantity(item.id, item.qt)}
                >
                  -
                </button>
                <div className={styles.itemqt}>{item.qt}</div>
                <button
